...
export default function EditCoursePage() {
  ...
  const removeImage = () => {
    setImageFile(null);
    setImagePreview(originalCourse?.image_url || null);
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      let imageUrl = originalCourse?.image_url;
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-[#1a5744]">Editar Curso</h1>
        <p className="text-gray-600 mt-2">Modifica la información del curso</p>
      </div>
